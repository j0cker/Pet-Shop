...
contract('petShop', function(accounts) {
  ...
  it("should let us sell a first article", function() {
    return petShop.deployed().then(function(instance) {
      petShopInstance = instance;
      return petShopInstance.sellArticle(articleName1, articleDescription1, web3.toWei(articlePrice1, "ether"), {
        from: seller
      });
  ...
  it("should let us sell a second article", function() {
    return petShop.deployed().then(function(instance) {
      petShopInstance = instance;
      return petShopInstance.sellArticle(articleName2, articleDescription2, web3.toWei(articlePrice2, "ether"), {
        from: seller
      });
    }).then(function(receipt) {
